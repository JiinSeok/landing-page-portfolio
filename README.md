...
경력과 프로젝트, 기술 스택, 자주 받는 질문을 한 페이지에 담았습니다. Next.js App Router로 구현했습니다.
...
- **스타일링**: Tailwind CSS 4, `tw-animate-css`, Radix UI Slot
- **UI 보조**: Lucide React(아이콘), Sonner(토스트)
...
src/
├── app/                  # App Router 라우트
│   ├── page.tsx          # 홈 (히어로 · 프로젝트 · 경력 · 기술 스택 · FAQ)
...
- **프로젝트 · 자료**: 프로젝트 · 과제 · 발표 · 설계 자료를 태그로 구분한 단일 갤러리
- **경력**: 도스트11 · 체인시프트 · 핏투게더 · 물류대장 · 연합뉴스 이력을 회사 로고와 함께 세로 타임라인으로 구성
- **기술 스택**: 5초마다 자동 전환되는 카테고리 탭
- **FAQ**: 자주 받는 질문을 문답 형태로 정리
