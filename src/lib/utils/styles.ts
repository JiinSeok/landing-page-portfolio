...
export function combineStyles(
  ...
  const classes = Array.isArray(tokenClasses) ? tokenClasses.join(' ') : tokenClasses
...
export const text = {
  ...
  heading: (level: 1 | 2 | 3 | 4 | 5 | 6, className?: string): string => {
    const headingToken = tokens.typography.responsiveFontSize[`h${level}` as keyof typeof tokens.typography.responsiveFontSize]
   ...
   * @returns Combined class string
   */
  body: (size: 'large' | 'default' | 'small' = 'default', className?: string): string => {
    const sizeMap = {
   ...
   * @returns Combined class string
   */
  ui: (size: 'large' | 'default' | 'small' = 'default', className?: string): string => {
    const sizeMap = {
...
export const layout = {
   ...
   * @returns Combined class string
   */
  container: (size: 'sm' | 'md' | 'lg' | 'xl' | '2xl' | 'prose' | 'full' = 'xl', className?: string): string => {
  ...
  grid: (columns: 1 | 2 | 3 | 4, className?: string): string => {
    return combineStyles(['grid', tokens.layout.responsive.grid[columns]], className)
  },
   ...
   * @returns Combined class string
   */
  flex: (direction: 'row' | 'column' | 'columnReverse' | 'rowColumn' | 'rowColumnReverse' = 'row', className?: string): string => {
    return combineStyles(['flex', tokens.layout.responsive.flexDirection[direction]], className)
  },
}
...
export const spacing = {
   ...
   * @returns Combined class string
   */
  padding: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  paddingX: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  paddingY: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  margin: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  marginX: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | 'auto' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  marginY: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  marginBottom: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  marginTop: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  gap: (size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' = 'md', className?: string): string => {
...
export const sizing = {
   ...
   * @returns Combined class string
   */
  icon: (size: 'xs' | 'sm' | 'md' | 'lg' | 'xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  avatar: (size: 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' = 'md', className?: string): string => {
   ...
   * @returns Combined class string
   */
  thumbnail: (size: 'sm' | 'md' | 'lg' | 'xl' = 'md', className?: string): string => {
