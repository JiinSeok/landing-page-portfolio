...
import { SITE_BUILD_FEATURES } from '@/lib/constants/sections/siteBuild'
...
export default function SiteBuildSection() {
  const t = useTranslations('pages.siteBuild')
      ...
      <div className="max-w-7xl mx-auto px-3">
        ...
        <div className="mt-16 bg-card p-8 rounded-lg shadow-md">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 md:space-x-4">
            ...
            <div className="block md:hidden text-2xl text-muted-foreground">
              ↓
            </div>
        ...
        <div className="mt-16 bg-card p-8 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground">
              Building this site provided valuable experience with Next.js App
              Router, React Server Components, and modern frontend development
              practices. Key learnings include:
            </p>
            <ul className="space-y-2 pl-6 list-disc">
              ...
              <li className="text-muted-foreground">
                Implementing responsive designs that work across all device
                sizes
              </li>
              <li className="text-muted-foreground">
