...
문헌정보학 전공에서 코딩을 배운 후 연합뉴스·물류대장·핏투게더에서 인물 DB 관리와 품질·고객 경험(CX)을 맡았고, 개선을 제안·전달하는 자리에서 직접 만들고 고치는 쪽으로 방향을 잡았습니다. 경력·프로젝트별 실행 화면과 발표 자료는 포트폴리오 사이트 usejiin.link에 타임라인으로 정리해 두었습니다.
...
- 5개 프로덕트 Jira 운영·기술 문서 위키화로 온보딩 지원
